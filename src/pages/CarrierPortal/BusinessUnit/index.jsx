...
const BusinessUnit = () => {
  ...
  // Note: totalRevenue is fetched from QuickBooks
  const businessUnits = [
    {
      id: 1,
      name: "Mega Logistics",
      isActive: true,
      totalRevenue: 2450000, // From QB
    },
    {
      id: 2,
      name: "Mega Trucking",
      isActive: true,
      totalRevenue: 1875000, // From QB
    },
  ];
  ...
  return (
    <div className="flex flex-col h-full overflow-auto bg-background">
      ...
      <Sheet open={isSheetOpen} onOpenChange={setIsSheetOpen}>
        <SheetContent side="right" className="w-full sm:max-w-xl px-0 flex flex-col h-full">
          <SheetHeader className="pb-2 border-b px-6">
          ...
          <div className="flex-1 overflow-y-auto px-6">
            <form onSubmit={handleSubmit} className="space-y-6 mt-4 px-2 pb-6" id="business-unit-form">
          ...
          <SheetFooter className="border-t p-4 bg-background px-8 shrink-0">
